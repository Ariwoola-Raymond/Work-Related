$(document).ready(function () {
    ...
    const duoCard = {
        ...
        earningRate: ['0.5%', '5%'],
        example: ['AED 100 → 0.5 Plus Point', 'AED 100 → 5 Plus Point'],
    ...
    const elevateCard = {
        ...
        spendType: ['Etihad Airways, ​Hotels, Dining & EY.com', '​International (non-EU) and Domestic spends', '​Insurance, Car Dealership, Grocery and Supermarkets, Quick Service Restaurants, Retail Spends in European Union (EU) Countries, Real Estate, Education, Petroleum, Transit, Government Services, Utility and Telecommunication Payments', '​<strong>Additional miles ​on all spends</strong>​'],
        earningRate: ['100%', '60%', '60%', '<strong>25%</strong>'],
        example: ['AED 10 →​​ 10 Etihad Miles', 'AED 10 → 6 Etihad Miles', 'AED 10 → 6 Etihad Miles <br>Capped at 1500 miles per billing cycle', '<strong>AED 10 → Additional 2.5 Etihad Miles</strong>'],
    ...
    const inspireCard = {
        ...
        example: ['AED 10 →​​ 7 Etihad Miles', 'AED 10 → 4 Etihad Miles', 'AED 10 → 4 Etihad Miles <br>Capped at 750 miles per billing cycle', '<strong>AED 10 → Additional 2.5 Etihad Miles</strong>'],
  ...
  // ! NEW CARD
    ...
    function calculateRewards() {
        ...
        // Card specific calculations
            ...
            // for (var i = 0; i < cardProfile.earningRatePercent.length; i++) {
            //     $(`#pointsEarned${i}`).html(openTag + (transactionAmount * cardProfile.earningRatePercent[i]).toFixed(2) + seperatorSpace + etihadMiles.rewardName + closeTag);
            // } 
            for (var i = 0; i < cardProfile.earningRatePercent.length; i++) {
