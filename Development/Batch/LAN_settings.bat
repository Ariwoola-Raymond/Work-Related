...
cmd.exe /c "start inetcpl.cpl,,4 && timeout /T 1 /NOBREAK && powershell.exe -Command \"Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.SendKeys]::SendWait('{TAB}{TAB}{SPACE}{TAB}{TAB}{TAB}{ENTER}');\""
